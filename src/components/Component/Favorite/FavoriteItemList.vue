    ...
    export default {
        ...
        methods: {
            ...
            removeItem(idx){
                ...
                if(r == 1){
                    this.deleteItemList.push(this.store.state.favorite[idx].id)
                    console.log(this.deleteItemList);
            ...
            submitFavorite() {
                ...
                if(r == 1){
                    var customerItemList = this.customerItemList;
                    var tbCustomer_ID = this.store.state.customer.id;
                    this.$http.post(baseurl + '/insertcustomeritem', {customerItemList, tbCustomer_ID})
                    .then((res) => {
                        var customerItemList = this.deleteItemList;
                        this.$http.delete(baseurl + '/deletecustomeritem', tbCustomer_ID)
                        .then((res) => {
